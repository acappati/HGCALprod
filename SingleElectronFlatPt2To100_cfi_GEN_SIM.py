...
# with command line options: SingleElectronFlatPt2To100_cfi -s GEN,SIM -n 10 --conditions auto:phase2_realistic_T25 --beamspot HLLHC --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry Extended2026D98 --era Phase2C17I13M9 --no_exec --fileout file:step1.root --nThreads 8
